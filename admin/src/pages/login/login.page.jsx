...
// GÜNCELLENEN KISIM: ThermaSense logosu import edildi
...
const Login = () => {
    ...
    // YENİ EKLENEN KISIM: API'den gelen hataları dinleyip ekrana basan yapı
    useEffect(() => {
        if (error) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        // GÜNCELLENEN KISIM: Sadece login isteği atılır, hata kontrolü yukarıdaki useEffect'e bırakılır.
        ...
        <div className="min-h-screen flex overflow-hidden">
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-950 flex-col items-center justify-center p-16 relative">
                ...
                <div className="relative z-10 text-center">
                    {/* GÜNCELLENEN KISIM: Masaüstü görünüm logosu ve alt metni ThermaSense yapıldı */}
                    <img src={ThermasenseLogo} alt="ThermaSense" className="h-16 mx-auto mb-10 object-contain opacity-90" />
            ...
            <div className="flex-1 flex items-center justify-center bg-slate-50 p-6">
                <div className="w-full max-w-sm animate-fadeSlideIn">
                    <div className="lg:hidden mb-8 text-center">
                        {/* GÜNCELLENEN KISIM: Mobil görünüm logosu ve alt metni ThermaSense yapıldı */}
                        <img src={ThermasenseLogo} alt="ThermaSense" className="h-12 mx-auto object-contain" />
                    </div>
